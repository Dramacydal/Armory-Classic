...
ARMORY_CMD_SET_USERACEICONS                 = "usericn";
ARMORY_CMD_SET_USERACEICONS_TEXT            = "use race icons for character names"; -- L["ARMORY_CMD_SET_USERACEICONS_TEXT"];
ARMORY_CMD_SET_USERACEICONS_MENUTEXT        = "Use race icons"; -- L["ARMORY_CMD_SET_USERACEICONS_MENUTEXT"];
ARMORY_CMD_SET_USERACEICONS_TOOLTIP         = "If enabled, race icons are used when displaying character names."; -- L["ARMORY_CMD_SET_USECLASSCOLORS_TOOLTIP"];
